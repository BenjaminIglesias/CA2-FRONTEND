...
document.getElementById("methodDropdown").addEventListener("click", function(evt) {
  switch (evt.target.id) {
    case "getBtn":  document.getElementById("divChangerMethod").innerHTML = htmlContentFacade.getGetHtml(), htmlContentFacade.fillTable(data); break
    case "postBtn": document.getElementById("divChangerMethod").innerHTML = htmlContentFacade.getPostHtml(),htmlContentFacade.fillTable(data); break
    case "putBtn":  document.getElementById("divChangerMethod").innerHTML = htmlContentFacade.getPutHtml(), htmlContentFacade.fillTable(data); break
    case "deleteBtn": document.getElementById("divChangerMethod").innerHTML = htmlContentFacade.getDeleteHtml(), htmlContentFacade.fillTable(data); break
